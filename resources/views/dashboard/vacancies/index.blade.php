                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> Search</button>
                                        ...
                                        <a href="{{ route('admin.vacancies.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach ($vacancies as $index=>$vacancy)
                                    <tr>
                                        ...
                                        <td>
                                                <a href="{{ route('admin.vacancies.edit', [$vacancy->id, $vacancy->slug])}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Delete {{ $vacancy->jobtitle }}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>You are going to delete {{ $vacancy->jobtitle }}. Are you sure?</p>
      </div>
